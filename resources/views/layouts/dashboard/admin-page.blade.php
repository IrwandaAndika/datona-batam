  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{asset('img/freddy.jpg')}}" class="img-square elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Freddy</a>
        </div>
      </div>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="/home" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Datona Home Page</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/cases-page" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cases</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/expertise-page" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Expertise</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/testimonials-page" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Testimonials</p>
                </a>
              </li>
